...
FILENAME="libSLAMARAndroid.so"

PROJECT_PATH=$(dirname $(cd $(dirname ${BASH_SOURCE[0]} ); pwd ) )
DEST_PATH="/Users/gaoxuanying/Desktop/AR_SDK_ygx/Android-AR-SDK/orbslam2_AR_android/fastinitslam/orbslam2-android-jni/jni"
NDK_PATH="/Users/gaoxuanying/Library/Android/sdk/android-ndk-r11c"
